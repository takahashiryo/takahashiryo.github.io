...
| `_data/facilities.yml` | Facilities ページ（/facilities/）。カテゴリ→機器の2段。機器は name/maker/image（images/facilities/）と ja/en/zh の desc/uses。描画は `_includes/page_facilities.html` | 手書き |
